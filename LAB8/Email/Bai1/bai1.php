<?php
          ...
          $mail = new PHPMailer\PHPMailer\PHPMailer(true);  //true: enables exceptions
		    ...
		    $matkhau = 'giyx mfnq vxob xjhz';// mật khẩu của tài khoản cuongnq.24itb@vku.udn.vn
		    $tennguoigui = 'owen';
    ...
    $email_array = explode(",",$recipients);*/
                ...
                $noidungthu = "<b>Chào đồ đệ, ta là Hải!</b><br>Hãy rep lại gmail của ta" ;
