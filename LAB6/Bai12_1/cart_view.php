...
<body>
    ...
    <main>
        ...
        <!-- Step 9: Add link to end session and delete cookie -->
        <p><a href=".?action=end_session" onclick="return confirm('This will end your session and delete the cookie. Continue?');">End Session and Delete Cookie</a></p>
